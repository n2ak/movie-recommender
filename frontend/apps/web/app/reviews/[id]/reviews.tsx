...
//     queryKey: keys,
//     initialData: r,
//     queryFn: () => getMovieReviewById(r.id, movie.id, userId),
//     refetchOnMount: false,
//   });
//   const qL = useQueryClient();
//   const react = useMutation({
//     mutationFn: async (type: "LIKE" | "DISLIKE") => {
//       if (userId) reactToMovieReview(userId, review!.id, type);
//     },
//     onSuccess: () => {
//       qL.invalidateQueries({ queryKey: keys });
//     },
...
//           <Button
//             variant={isLiked ? "default" : "outline"}
//             onClick={async () => await react.mutate("LIKE")}
//             disabled={!userId}
//           >
//             {nLikes}
//             <ThumbsUp />
...
//           <Button
//             variant={isDisLiked ? "default" : "outline"}
//             onClick={async () => await react.mutate("DISLIKE")}
//             disabled={!userId}
//           >
//             {nDislikes}
//             <ThumbsDown />
